                    ...
                    <div className="overflow-hidden">
                      <table className="table-fixed w-full">
                        ...
                        <tbody>
                          ...
                          <td className="text-sm text-gray-900 font-light px-6 py-4 ">
                            Chiều ngày 30/11/2020, Hội đồng khoa học Bảo
                            tàng Bắc Ninh tổ chức Hội nghị nghiệm thu
                            bảo quản hiện vật ngoài trời (gồm: 01 máy
                            bay Mic 21, 01 súng cao xạ, 01 pháo cao xạ)
                            và 15 hiện vật gốm tu sửa, phục dựng (01 đầu
                            rồng, 03 thiên nga, 03 tháp, 01 vò, 04 lá
                            đề, 01 bình, 01 đầu ngói ống, 01 bộ phận
                            chân đèn- đều là những hiện vật có giá trị
                            lớn về mặt lịch sử, mỹ thuật, trong đó phần
                            lớn là thời Lý). Đồng chí Nguyễn Thị Trọng -
                            Giám đốc Bảo tàng, Chủ tịch Hội đồng khoa
                            học cơ sở chủ trì Hội nghị; đại diện Công ty
                            TNHH Công nghệ bảo quản, bảo tồn di sản và
